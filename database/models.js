...
//       p.user_id = withinThirty.id
//     WHERE
//       p.deleted = false) withinThirty
//     ON
//       withinThirty.user_id = user_id
// INNER JOIN
//   (
//     SELECT
//       1 user_id,
...
//       p.user_id = withinForty.id
//     WHERE
//       p.deleted = false) withinForty
//     ON
//       withinForty.user_id = user_id
// INNER JOIN
//   (
//     SELECT
//       1 user_id,
...
//       p.user_id = withinFifty.id
//     WHERE
//       p.deleted = false) withinFifty
//     ON
//       withinFifty.user_id = user_id`,
